...
import io.aistac.common.canonical.data.ObjectEnum;
import io.aistac.common.data.obcache.objectstore.ObjectSetBean;
import io.aistac.common.data.obcache.objectstore.ObjectSetBean;
import java.util.*;
...
public class ExampleInheritBean extends ObjectSetBean {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 79 * hash + this.ref;
        hash = 79 * hash + Objects.hashCode(this.refName);
        hash = 79 * hash + Arrays.hashCode(this.days);
        hash = 79 * hash + Objects.hashCode(this.refNameSet);
